...
void loop()
{
  ...
  if ((millis() - contadorLectura) > serialTimer)
  {
    ...
    //    (alarmaSensor || alarmaPresionAlta || alarmaPresionBaja || alarmaAmbu || alarmaSensor2 || alarmaBloqueo) && startCycle) || alarmaeStop || alarmaBateria)
